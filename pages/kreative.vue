  ...
  <LandingContainer>
    ...
    <div class="flex flex-col gap-3 mx-auto max-w-4xl mt-16">
      ...
      <p class="text-lg leading-relaxed text-slate-500">
        Hos <strong>Aktivitetstilbud</strong> tror vi på, at kreativ udfoldelse er en vigtig del af vores livsglæde. Vi tilbyder en række kreative aktiviteter, der giver dig mulighed for at udtrykke dig gennem kunst og håndværk i en positiv og inkluderende atmosfære.
      </p>

      <h3 class="font-bold text-xl text-gray-800">
        Vores Kreative Aktiviteter
      </h3>
      <ul class="list-disc list-inside mb-6 text-lg leading-relaxed text-slate-500">
        <li class="mb-2">
          <strong>Maleri og Tegning:</strong> Udfold din indre kunstner med workshops i maleri og tegning, hvor du kan skabe dine egne kunstværker.
        </li>
        <li class="mb-2">
          <strong>Keramik:</strong> Deltag i keramikworkshops og lær at forme og dekorere dine egne keramiske kreationer.
        </li>
        <li class="mb-2">
          <strong>Håndværk og DIY Projekter:</strong> Engager dig i forskellige håndværksprojekter, fra strikning og syning til DIY dekorationer.
        </li>
        <li class="mb-2">
          <strong>Kreative Skriveværksteder:</strong> Udforsk dine skrivefærdigheder med workshops, der fokuserer på kreativ skrivning og poesi.
        </li>
      </ul>
      ...
      <p class="text-lg leading-relaxed text-slate-500">
        Vi tilbyder et inkluderende miljø, hvor alle kan deltage og finde glæde i at skabe. Vores erfarne instruktører er her for at støtte dig, uanset om du er nybegynder eller erfaren. Kontakt os for at finde ud af, hvordan du kan blive en del af vores kreative fællesskab og begynde at udforske dine kreative sider.
      </p>
      <p class="text-lg leading-relaxed text-slate-500">
        Hos <strong>Aktivitetstilbud</strong> handler det om at finde glæde gennem kunst og håndværk. Vi ser frem til at hjælpe dig med at udtrykke din kreativitet på måder, du aldrig har forestillet dig!
      </p>
    </div>
